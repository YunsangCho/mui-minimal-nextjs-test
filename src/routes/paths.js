...
export const paths = {
  ...
  dashboard: {
    ...
    baseInfo: {
      root: `${ROOTS.DASHBOARD}/base-info`,
      specInfo: `${ROOTS.DASHBOARD}/base-info/spec-info`,
      crossCheck: `${ROOTS.DASHBOARD}/base-info/cross-check`,
    },

    receiveAlc2Data: {
      root: `${ROOTS.DASHBOARD}/receive-alc2-data`,
      inquiry: `${ROOTS.DASHBOARD}/receive-alc2-data/inquiry`,
    },
  },
};
